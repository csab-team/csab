...
ConVar cv_chat ("cb_chat", "1", "Enables or disables bots chat functionality.");
ConVar cv_chat_percent ("cb_chat_percent", "30", "Chances bot will send random dead chat when killed.", true, 0.0f, 100.0f);
